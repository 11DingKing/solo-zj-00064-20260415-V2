package com.github.throyer.example.modules.infra.constants;
...
public class MessagesConstants {
    ...
    public static final String BLACKLISTED_TOKEN_MESSAGE = "blacklisted.token.error.message";
    public static final String TOO_MANY_REQUESTS_MESSAGE = "too.many.requests.error.message";
}
